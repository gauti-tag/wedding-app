...
export function GuestbookSection({
  ...
  return (
    <section id="guestbook" className="site-section site-section--border-t bg-forest/50">
      <div className="section-shell site-section-grid lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <Reveal className="site-section-head">
          ...
          <form onSubmit={onSubmit} className="site-section-body site-section-panel site-section-stack max-w-xl">
            <div>
